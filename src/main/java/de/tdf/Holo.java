...
public class Holo {
	...
	public UUID getUuid() {
		return UUID.fromString(getString(as.getWorld().getName() + "-" + as.getWorld().getUID() + "." + name + ".uuid"));
	}

	public UUID getUuidFrom(Player p) {
		return UUID.fromString(getString(p.getWorld().getName() + "-" + p.getWorld().getUID() + "." + name + ".uuid"));
	}

	public void remove() {
		as.remove();
		c.set(as.getWorld().getName() + "-" + as.getWorld().getUID() + "." + name, as);
	}

	public void setUp(String pName, String pDisplay) {
		String s = as.getWorld().getName() + "-" + as.getWorld().getUID() + "." + name;
		rename(pName);
